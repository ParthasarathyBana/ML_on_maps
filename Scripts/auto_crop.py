...
def crop_rotated_rectangle_test():
    ...
    img = cv2.imread('/home/glaurung/catkin_ws/src/reddy_autonomy/maps/world.png')
    ...
    cv2.drawContours(img,[box],0,(255,150,0),1)
    cv2.arrowedLine(img, center, ((box[1][0]+box[2][0])//2,(box[1][1]+box[2][1])//2), (15,150,0), 1, tipLength = 0.1)
